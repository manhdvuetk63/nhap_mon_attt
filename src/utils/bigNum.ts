...
//         (answerInArray[answerInArray.length - j] as any) +=
...
//       answerIn7DigitBlocksArray[answerIn7DigitBlocksArray.length - i] =
...
//           );
//       (answerInArray[answerInArray.length - i - 1] as any) += parseInt(
//         answerInArray[answerInArray.length - i]
//           .toString()
//           .substring(
//             0,
...
//   if (isASingleDigit) {
//     (answerIn7DigitBlocksArray[
//       answerIn7DigitBlocksArray.length - 1
//     ] as any) /= 10;
//   }
//   if (isBSingleDigit) {
//     (answerIn7DigitBlocksArray[
